...
export interface ServiceStrategyAccordionSectionProps {
  id?: string;
...
export function ServiceStrategyAccordionSection({
  id = "service-strategy-accordion",
  title,
  subtitle,
  items,
  allowMultiple = true,
  className = "",
}: ServiceStrategyAccordionSectionProps) {
  return (
    <section
      id={id}
