...
export default function MagicRings({
  ...
  useEffect(() => {
    ...
    const animate = (t) => {
      ...
      // Throttle render loop to ~35-40 FPS (every 25ms) to keep CPU at near 0% on desktop & mobile
      if (t - lastRenderT < 25) return;
      lastRenderT = t;
    ...
    const idleTimer = typeof window !== 'undefined' && 'requestIdleCallback' in window
      ? window.requestIdleCallback(() => tryStart(), { timeout: 300 })
